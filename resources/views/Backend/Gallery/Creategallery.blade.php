            ...
            <div class="card">
                ...
                <div class="card-body" style="background-color:  #fcf8f3;">
                    <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="text" placeholder="Gallery title" name="gallery_title" class="form-control my-3">
                        @error('gallery_title')
                        ...
                        @enderror
                        <br>
                        <button type="submit" class="btn btn-primary"> Insert Gallery Item</button>
                    </form>
                </div>
            </div>
        </div>
