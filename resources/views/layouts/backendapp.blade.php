    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="{{ asset('backend/image/creative it.png') }}"
                        style="height:60px; padding:5px 0;" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="{{ asset('backend/image/creative it.png') }}"
                        alt="Logo"></a>
            </div>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul>
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ route('about.create') }}">Add
                                    About
                                    item</a></li>
                            <li><i class="menu-icon ti-split-h"></i><a href="{{ route('about.index') }}">All
                                    About
                                    item</a>
                            </li>
                        </ul>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="#"><i class="ti-save-alt"></i>
                                {{ Auth::user()->name }}</a>
